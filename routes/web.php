...
Route::get('/admin/master/kecamatan-desa', fn() => view('admin.master.irigasi-kecamatan'))->name('master.irigasi-kecamatan');
Route::get('/admin/master/masa-tanam', fn() => view('admin.master.masa-tanam'))->name('master.masa-tanam');
