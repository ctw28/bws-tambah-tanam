                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" v-model="form.saluran_id" @change="checkSaluran">
                                ...
                                <option v-for="s in salurans" :key="s.id" :value="s.id">
                                    @{{ s.nama }} - DI @{{ s.daerah_irigasi.nama }} - Kab.
                                    @{{ s.daerah_irigasi.kabupatens[0].nama }}
                                </option>
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div v-if="form.petak_id && previewPetak" class="mt-3">
                                ...
                                <img :src="`/storage/${previewPetak}`" class="img-fluid rounded shadow"
                                    alt="Gambar Petak">
                        ...
                        <button type="button" class="btn btn-primary" :disabled="!isReadyToContinue" @click="showForm">
                    ...
                    <div class="card shadow-lg p-4 mt-1" id="showForm">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" v-model="form.tanggal_pantau"
                                    @change="validasiHariMinggu" :min="minDate" :max="maxDate" required>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Upload Foto Pemantauan (foto dengan Koordinat) <span
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" v-model="p3aSearch"
                                    placeholder="Ketik minimal 3 huruf untuk mencari P3A..." @input="searchP3A">

                                <!-- dropdown hasil pencarian -->
                                <div v-if="showP3ASearch && p3aResults.length"
                                    class="border rounded mt-1 bg-white position-absolute w-50 shadow-sm"
                                    style="z-index: 1000;">
                                    <div v-for="p in p3aResults" :key="p.id" class="p-2 hover-bg" @click="selectP3A(p)"
                                ...
                                <!-- daftar P3A terpilih -->
                                <div class="mt-2">
                                    <span v-for="(p, i) in form.p3a" :key="p.id" class="badge bg-primary me-2">
                                        @{{ p.nama }}
                                        <button type="button" class="btn-close btn-close-white btn-sm ms-1"
                                            style="font-size: .6rem;" @click="removeP3A(i)">
                                        </button>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="card shadow-lg p-4 mt-1">
                        ...
                        <div v-for="(p,index) in permasalahans" :key="p.id" class="mb-4 pb-3">
                            ...
                            <div v-if="form.permasalahan[p.id].status === 'ada'" class="mt-3">
                                ...
                                <input type="file" class="form-control" @change="handleFile($event, p.id)"
                                ...
                                <div v-if="form.permasalahan[p.id].foto_permasalahanPreview" class="mt-3">
                                    <img :src="form.permasalahan[p.id].foto_permasalahanPreview" alt="Preview Foto"
                            ...
                            <div class="mb-2" v-for="(p, index) in form.permasalahan" :key="p.id">
                                <span class="fw-semibold">
                                    <div v-if="p.status=='ada'">
                                        @{{ index }}.
                                        @{{ permasalahans.find(pm => pm.id == p.master_permasalahan_id)?.nama }} <br>
                                        <span class="text-danger fw-bold">
                                            Ada
                                        </span> <br>
                                        Keterangan : @{{ p.keterangan || '-' }}<br>
                                        Foto permasalahan :
                                        <img :src="p.foto_permasalahanPreview" alt="Preview Foto Permasalahan"
                                            class="img-fluid rounded" width="300">
                                    </div>
            ...
            methods: {
                validasiHariMinggu() {
                    ...
                    if (tgl.getDay() !== 0) {
                        ...
                        alert(
                            `Tanggal yang Anda pilih (${tanggalAsli}) bukan hari Minggu. \nPengisian akan dialihkan ke tanggal Minggu terdekat: ${this.form.tanggal_pantau}`
                        );
                    }
                },

                async searchP3A() {
                    let juru = JSON.parse(localStorage.getItem("juru"));
                    let diId = juru.salurans[0].daerah_irigasi_id
                    ...
                    this.searchTimeout = setTimeout(async () => {
                        try {
                            let res = await axios.get(
                                `/api/master/p3a?search=${this.p3aSearch}&per_page=all&daerah_irigasi_id=${diId}`
                            );
                            this.p3aResults = res.data.data || res
                                .data; // bisa paginate atau full
                ...
                checkPetak() {
                    ...
                    if (petak && petak.gambar_skema) {
                        ...
                        this.infoGambarSkema =
                            'Apabila gambar petak tidak sesuai, silahkan isi di PERMASALAHAN LAINNYA dan hubungi koordinator untuk perubahan.';
                    } else {
                        this.previewPetak = null;
                        this.infoGambarSkema =
                            'Gambar petak belum tersedia. Silahkan isi di PERMASALAHAN LAINNYA dan hubungi koordinator untuk penginputan gambar petak.';
                    }
                },
                async getKabupaten() {
                ...
                async submitForm() {
                    ...
                    for (let id in this.form.permasalahan) {
                        ...
                        formData.append(`permasalahan[${index}][master_permasalahan_id]`, p
                        ...
                        if (p.foto_permasalahan instanceof File) {
                            formData.append(`permasalahan[${index}][foto_permasalahan]`, p
                                .foto_permasalahan);
                        }
                        index++;
                    }
                    ...
                    if (Array.isArray(this.form.p3a)) {
                        this.form.p3a.forEach((p, index) => {
                            formData.append(`p3a[${index}][p3a_id]`, p
                                .id); // ✅ gunakan p.id, bukan p.p3a_id
                        });
                    }
